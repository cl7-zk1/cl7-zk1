...
import { BlueprintExampleData } from "../util/tagTypes";
...
//     // private handleAutoFocusChange = handleBooleanChange((autoFocus:any) => this.setState({ autoFocus }));

//     // private handleBackdropChange = handleBooleanChange((hasBackdrop:any) => this.setState({ hasBackdrop }));

//     // private handleEnforceFocusChange = handleBooleanChange((enforceFocus:any) => this.setState({ enforceFocus }));

//     // private handleEscapeKeyChange = handleBooleanChange((canEscapeKeyClose:any) => this.setState({ canEscapeKeyClose }));

//     // private handleUsePortalChange = handleBooleanChange((usePortal:any) => this.setState({ usePortal }));

//     // private handlePositionChange = handleValueChange((position: Position) => this.setState({ position }));

//     // private handleOutsideClickChange = handleBooleanChange((val:any) => this.setState({ canOutsideClickClose: val }));

//     // private handleSizeChange = handleStringChange((size:any) => this.setState({ size }));
